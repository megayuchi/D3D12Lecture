...
BOOL __stdcall CD3D12Renderer::Initialize(HWND hWnd, BOOL bEnableDebugLayer, BOOL bEnableGBV, BOOL bUseGpuUploadHeaps, const WCHAR* wchShaderPath)
{
	BOOL	bResult = FALSE;
...
BOOL __stdcall CD3D12Renderer::IsGpuUploadHeapsEnabled() const
{
