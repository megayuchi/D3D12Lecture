...
{
	virtual BOOL	__stdcall Initialize(HWND hWnd, BOOL bEnableDebugLayer, BOOL bEnableGBV, BOOL bUseGpuUploadHeaps, const WCHAR* wchShaderPath) = 0;
	...
	virtual BOOL	__stdcall IsGpuUploadHeapsEnabled() const = 0;
};