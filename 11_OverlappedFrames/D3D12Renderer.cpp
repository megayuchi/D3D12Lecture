...
lb_exit:
	...
	for (DWORD i = 0; i < MAX_PENDING_FRAME_COUNT; i++)
	{
		...
		m_ppDescriptorPool[i]->Initialize(m_pD3DDevice, MAX_DRAW_COUNT_PER_FRAME * CBasicMeshObject::DESCRIPTOR_COUNT_FOR_DRAW);
...
void CD3D12Renderer::RenderMeshObject(void* pMeshObjHandle, const XMMATRIX* pMatWorld, void* pTexHandle)
{
	...
	pMeshObj->Draw(pCommandList, pMatWorld, srv);
}
